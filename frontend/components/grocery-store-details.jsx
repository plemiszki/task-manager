...
export default class GroceryStoreDetails extends React.Component {
  ...
  dropHandler(e, ui) {
    ...
    const grocerySection = grocerySections.find(
      ...
      <>
          ...
          <div className="white-box">
            ...
            {grocerySections.map((grocerySection, index) => {
              ...
              return (
                <div
                  className="section"
                  key={grocerySection.id}
                  data-grocery-section-id={grocerySection.id}
                >
                  ...
                  <ListBoxReorderable
                    ...
                    clickAdd={() => {
                      this.setState({
                        itemsModalOpen: true,
                        selectedSectionId: grocerySection.id,
                      });
                    }}
                    clickDelete={(listItemId) =>
                      this.clickDeleteItem(listItemId)
                    }
        ...
        >
          <NewEntity
            ...
            callback={(grocerySections) =>
              this.setState({ grocerySections, newSectionModalOpen: false })
            }
